...
//
// Reference translators — a proof of concept until platforms read `org.agentrc.*`
// labels natively. Not production runners.
const localPositioning = "Reference translators — a proof of concept until platforms read `org.agentrc.*` labels natively. Not production runners."
